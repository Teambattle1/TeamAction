        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-slate-900">
          ...
          <div className="bg-slate-950 border border-slate-800 rounded-2xl p-4">
              <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                      <p className="text-xs font-black uppercase tracking-widest text-white">GLOBAL SOUNDS</p>
                      <p className="text-[10px] font-bold uppercase tracking-wider text-slate-500 mt-1">
              ...
              <div className="mb-4">
                  ...
                  <select
                      ...
                      className="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-2.5 text-xs text-white font-medium outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20"
                  >
              ...
              <div className="mb-4">
                  ...
                  <div className="flex gap-2 mt-2">
                      <button
                          ...
                          className="flex-1 px-3 py-2 bg-red-600/20 hover:bg-red-600/30 border border-red-600/50 text-red-400 rounded-lg text-[10px] font-bold uppercase tracking-wide transition-colors flex items-center justify-center gap-2"
                      >
                          <Play className="w-3 h-3" /> Preview
                      </button>
                      <button
              ...
              <button
                  ...
                  className={`w-full px-4 py-3 rounded-xl font-black uppercase text-[10px] tracking-widest transition-all flex items-center justify-center gap-2 ${
                      soundsSaved
