...
import { Game, GameMode, LocationSearchProps, Coordinate, Team } from '../types';
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    ...
                                    <button
                                        ...
                                        className="py-2 px-2 bg-green-700 hover:bg-green-800 text-green-100 text-xs font-bold uppercase tracking-wider rounded-lg flex flex-col items-center gap-1 transition-all col-span-2"
                                        title="Map Styles"
                                    >
