                               ...
                               >
                                   ...
                                   <div className="flex-1">
                                       <div className="flex items-center justify-between">
                                           ...
                                           <ChevronDown className={`w-5 h-5 text-blue-600 transition-transform ${expandedActivations.location ? 'rotate-180' : ''}`} />
                                       </div>
                                           ...
                                           {editedPoint.location ? (
                                               <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-blue-200 dark:border-blue-700">
                                                   ...
                                                   <button
                                                       ...
                                                       className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-black text-sm uppercase tracking-wider transition-all flex items-center justify-center gap-2 mb-3"
                                                   >
                                                   ...
                                                   <button
                                                       ...
                                                       className={`w-full py-3 rounded-xl font-black text-sm uppercase tracking-wider transition-all flex items-center justify-center gap-2 border-2 ${editedPoint.isLocationLocked ? 'bg-blue-600 text-white border-blue-700 shadow-lg shadow-blue-500/30' : 'bg-white dark:bg-gray-800 text-blue-600 border-blue-300 dark:border-blue-700 hover:bg-blue-50 dark:hover:bg-gray-700'}`}
                                                   >
                                                   ...
                                                   {editedPoint.isLocationLocked && (
                                                       <div className="bg-blue-100 dark:bg-blue-900/30 border border-blue-300 dark:border-blue-700 rounded-lg p-3 mt-3">
