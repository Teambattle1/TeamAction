...
import {
    ...
    Wand2, Zap, CheckCircle, XCircle, GripHorizontal, Navigation, AlertTriangle, QrCode, Target, Loader2, MapPin
} from 'lucide-react';
        ...
        <div className="fixed inset-0 z-[5000] bg-[#0f172a] text-white flex flex-row overflow-hidden font-sans animate-in fade-in">
            ...
            >
                <button
                    ...
                    title={isQRScannerActive ? 'Scanning... click to stop' : 'Click to scan QR code'}
                    type="button"
                >
