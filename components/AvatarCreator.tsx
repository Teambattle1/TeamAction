            ...
            <div className="space-y-4">
                <div>
                    ...
                    <div className="flex gap-2">
                        ...
                        <button 
                            ...
                            className="bg-orange-600 hover:bg-orange-700 disabled:opacity-50 text-white p-2 rounded-xl transition-colors shadow-lg"
                        >
                ...
                {previewImage && (
                    <div className="grid grid-cols-2 gap-3 pt-2">
                        <button 
                            onClick={() => { setPreviewImage(null); setKeywords(''); }}
