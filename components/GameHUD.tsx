...
import {
    ...
    MapPin, Play, LogOut, Navigation as NavigationIcon, ExternalLink, Trophy, Hash, Type, QrCode, Target, Maximize, GitBranch, ScrollText
} from 'lucide-react';
...
const MAP_STYLES_LIST: { id: MapStyleId; label: string; icon: any; preview?: string; className?: string }[] = [
    ...
    { id: 'ancient', label: 'Ancient', icon: ScrollText, preview: 'https://a.tile.openstreetmap.org/13/4285/2722.png', className: 'sepia-[.8] contrast-115 brightness-85' },
